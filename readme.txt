...
To use first of all visit the options page. In the Administration menu, under the Settings section there will a new settings option titled "Code Embed" (see screenshots). Click on this and an options screen will appear.
...
For problems, suggestions or enhancements for this plugin, there is [a dedicated page](http://www.artiss.co.uk/code-embed "Simple Social Bookmarks") and [a forum](http://www.artiss.co.uk/forum "WordPress Plugins Forum"). The dedicated page will also list any known issues and planned enhancements.
